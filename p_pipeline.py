...
def domain_results_dir(domain_name, run_folder=None, results_root="experimental results"):
    """Output dir for a run: '<results_root>/<domain>/<run_folder or "general">'.
    ...
    results_root defaults to 'experimental results'; exploratory ufr-speedup runs
    (racing, etc.) pass 'ufr_experiments' so they stay out of the main results tree.
    """
    return os.path.join(results_root, domain_name, run_folder if run_folder else "general")
